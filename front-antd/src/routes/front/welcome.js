...
class Index extends React.Component{
    ...
    render(){
        ...
        return (
            <OverPack style={{width: '100%',}} always={true} playScale={0.5} className={classes.main}>
                    <QueueAnim key="queue"
                               leaveReverse
                               style={{position: 'relative',}}
                    >
                        <Banner key="banner" classes={classes}/>
                        <Service key="service" classes={classes} data={front} dispatch={dispatch}/>
                                        ...
                                        <div className={classes.productItemMid}>
                                            ...
                                            <div className={classnames(classes.pMain)}>
                                                <div className={classnames(classes.pPrice)}>
                                                    ...
                                                    <span
                                                        style={{fontSize: 14, fontWeight: 600}}>Professional plan</span>
                                ...
                                <div className={classes.proDetails}>
                                    <div className={classes.pdLeft}>
                                        ...
                                        <p style={{color: 'rgba(255,255,255,0.6)'}}>
                                            ...
                                            GuGe's material design style is used to provide an infinite approximation of
                                            the operation fluency and experience of the app,
