...
export default class Demo extends React.Component {
    constructor(props) {
        ...
        this.state = {
          ...
          /*  order:[
                {name:'Name Store 1921378'},
                {name:'Name Store 2523478'},
                {name:'Name Store 0521378'},
                {name:'Name Store 4921378'},
            ]*/
        };
    };
                ...
                {range(itemsCount).map(i => {
                    const style = originalPosOfLastPressed === i && isPressed
                        ...
                        : {
                            ...
                            y: spring(order.indexOf(i) * 72, springConfig),
                        };
                    return (
                        <Motion style={style} key={i}>
                            {({scale, shadow, y}) =>
                                <div
                                    ...
                                    {order.indexOf(i) + 1} Draggable List
                                </div>
                            }
                        </Motion>
                    );
